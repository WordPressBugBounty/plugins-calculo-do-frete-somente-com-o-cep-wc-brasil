...
class WC_Br_Shipping_Only_With_Cep {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'plugin_action_links_calculo-do-frete-somente-com-o-cep-wc-brasil/wc-br-shipping-only-with-cep.php', $plugin_admin, 'filter_plugin_links', 10, 1);
